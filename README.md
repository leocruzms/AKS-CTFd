...
This project sets up a self-hosted, secured [CTFd][ctfd] environment using Azure PaaS. It is meant to be used at a CTF event using [AKS Capture the Flag](https://github.com/lastcoolnameleft/aks-ctf) challenges.

The repo is based on the CTFd on Azure PaaS project [CTFd on Azure PaaS](https://github.com/Azure-Samples/ctfd-azure-paas) with the CTFd version 3.7.3 
